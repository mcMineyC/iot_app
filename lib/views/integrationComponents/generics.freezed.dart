...
mixin _$IntegrationUiDefinition {
 ...
 String get label; String get integrationId; IntegrationUiType get type;// required String dataPath,
 String get evaluatorScript; String get outputTransformer;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,label,integrationId,type,evaluatorScript,outputTransformer);

@override
String toString() {
  return 'IntegrationUiDefinition(label: $label, integrationId: $integrationId, type: $type, evaluatorScript: $evaluatorScript, outputTransformer: $outputTransformer)';
}
...
@useResult
$Res call({
 String label, String integrationId, IntegrationUiType type, String evaluatorScript, String outputTransformer
});
...
/// Create a copy of IntegrationUiDefinition
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? label = null,Object? integrationId = null,Object? type = null,Object? evaluatorScript = null,Object? outputTransformer = null,}) {
...
as IntegrationUiType,evaluatorScript: null == evaluatorScript ? _self.evaluatorScript : evaluatorScript // ignore: cast_nullable_to_non_nullable
as String,outputTransformer: null == outputTransformer ? _self.outputTransformer : outputTransformer // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String label,  String integrationId,  IntegrationUiType type,  String evaluatorScript,  String outputTransformer)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IntegrationUiDefinition() when $default != null:
return $default(_that.label,_that.integrationId,_that.type,_that.evaluatorScript,_that.outputTransformer);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String label,  String integrationId,  IntegrationUiType type,  String evaluatorScript,  String outputTransformer)  $default,) {final _that = this;
switch (_that) {
case _IntegrationUiDefinition():
return $default(_that.label,_that.integrationId,_that.type,_that.evaluatorScript,_that.outputTransformer);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String label,  String integrationId,  IntegrationUiType type,  String evaluatorScript,  String outputTransformer)?  $default,) {final _that = this;
switch (_that) {
case _IntegrationUiDefinition() when $default != null:
return $default(_that.label,_that.integrationId,_that.type,_that.evaluatorScript,_that.outputTransformer);case _:
  return null;
...
class _IntegrationUiDefinition implements IntegrationUiDefinition {
  const _IntegrationUiDefinition({required this.label, required this.integrationId, required this.type, required this.evaluatorScript, required this.outputTransformer});
...
/// Create a copy of IntegrationUiDefinition
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? label = null,Object? integrationId = null,Object? type = null,Object? evaluatorScript = null,Object? outputTransformer = null,}) {
